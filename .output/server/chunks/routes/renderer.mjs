...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Nuxt 4 Drumcomputer with WebAudio and MIDI"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Drumcomputer"};
